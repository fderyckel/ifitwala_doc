...
@theme {
  ...
  --color-ink: ${theme.ink_color};
  --color-slate: ${theme.slate_color};
  --color-canopy: ${theme.canopy_color};
  --color-leaf: ${theme.leaf_color};
  --color-moss: ${theme.moss_color};
  --color-sky: ${theme.sky_color};
  --color-sand: ${theme.sand_color};
